...
//        Log.i(TAG, "onSizeChanged: w:" + w + " h:" + h + " oldw:" + oldw + " oldh:" + oldh);
    ...
    public void showEmojiLayout() {
        ...
        LinearLayout.LayoutParams params = (LayoutParams) mContentLayout.getLayoutParams();
        params.height = mCurrentContentHeight;
        params.weight = 0;

        LinearLayout.LayoutParams params2 = (LayoutParams) mEmojiLayout.getLayoutParams();
